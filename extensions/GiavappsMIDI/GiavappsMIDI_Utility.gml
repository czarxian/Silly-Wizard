#define midi_note_name

/// @function midi_note_name
/// @description Gets the name of the note from the given note number.
/// @param {integer} noteNumber Note number (0-127).

var notenum, octavenum;
notenum = argument0 mod 12;
octavenum = argument0 div 12;
...
#define midi_instrument_name

/// @function midi_instrument_name
/// @description Gets the name of the instrument from the given instrument number.
/// @param {integer} instrumentNumber Instrument number (0-127).
...
#define midi_tempo_to_bpm

/// @function midi_tempo_to_bpm
/// @description Converts the given tempo (in microseconds) into BPM (Beats Per Minute).
/// @param {integer} microseconds Tempo (in microseconds).

return 60000000 / argument0;

#define midi_bpm_to_tempo

/// @function midi_bpm_to_tempo
/// @description Converts the given BPM (Beats Per Minute) into tempo (in microseconds).
/// @param {integer} beatsPerMinute Beats per minute.

return (500000 / argument0) * 120;
