...
| `scr_game_viz.gml` | `gv_gameviz_draw_perf_summary_popup(_x1, _y1, _x2, _y2, _summary)` | Draws an on-canvas perf details popup (with close button) launched from the status tile. | `global.timeline_state.perf_summary_popup`, summary struct fields | `global.timeline_state.perf_summary_popup` | `gv_draw_gameviz_controls_panel` |
